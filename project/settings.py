...
SECRET_KEY = 'django-insecure-25^=y=d$oklmyqp%l2ge=!1if=o1!qb$w#bghh*pifo@fefimm'
...
AUTH_USER_MODEL = 'app.User'  # Замените 'app' на имя вашего приложения
...
CORS_ALLOWED_ORIGINS = [
    "https://sakura-flow.onrender.com",
